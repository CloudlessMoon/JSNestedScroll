...
- (void)onceHookAdjustContentOffset:(void(^)(UIScrollView *scrollView, BOOL isExecuted))adjustContentOffset
                   setContentOffset:(void(^)(UIScrollView *scrollView, CGPoint offset, BOOL animated))setContentOffset NS_SWIFT_NAME(onceHook(adjustContentOffset:setContentOffset:));
